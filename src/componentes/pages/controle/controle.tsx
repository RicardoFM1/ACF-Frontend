...
const clickInformacoes = async (id: number) => {
  ...
  const atualizarCampo = async (campoData: iAtualizarCampos) => {
    ...
    try {
      ...
      console.log(error);
      toastbar.error(error.response?.data?.message || "Erro ao atualizar campo");
    }
    console.log("chamado")
  };
      ...
      <div className={style.fundoModal}>
        <div className={style.tituloModalInfoCampos}>
          ...
          <div className={style.divBtnFecharModal}>
            <button type="button" className={style.btnFecharModal} onClick={onClose}>X</button>
          </div>
        </div>
        <div className={style.modalInfo}>
          <form className={style.formCampo} onSubmit={handleSubmit(atualizarCampo)}>
            ...
            <div className={style.infoEsquerda}>
              ...
              <div className={style.divDescricaoCampo}>
                ...
                <div className={style.caixaDescricao}>
                  ...
                  {errors.descricao && <p className={style.error}>{errors.descricao.message}</p>}
                </div>
              </div>

              <div className={style.contatoCampo}>
                <p>Caso não tenha encontrado uma informação que deseja aqui, entre em contato conosco</p>
              </div>
            </div>
            ...
            <div className={style.divImagensCampo}>
              ...
              <button type="submit" className={style.btnSalvar}>Salvar</button>
            </div>
          </form>
        </div>
      </div>
